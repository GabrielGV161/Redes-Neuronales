...
¡No, por Dios! 🛑 Esa parte NO va en el README.

Esa sección en español ("Un último consejo...") eran mis instrucciones privadas para ti, para explicarte qué hacer con la captura de pantalla. Si pones eso en el README público, parecerá que has copiado y pegado sin leer y quedará poco profesional.

El README.md debe contener solo la información técnica del proyecto en inglés.

Aquí tienes el código FINAL, LIMPIO Y COMPLETO (desde el título hasta las referencias). Copia exactamente esto:
...
Biophysical modeling of STDP and Competitive Learning.
